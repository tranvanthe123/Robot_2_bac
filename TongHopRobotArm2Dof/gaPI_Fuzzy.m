...
max_stall_generation=10; %% 50 the he giong nhau thì dung
epsilon=0.0001; %% J chuan ( neu the he nào có J<=epsilon tuc là tìm dc thông so thoa man, thì dung)
pop_size=20; %%so cá the trong quan the, moi cá the có moi bo PID riêng biet
npar = 4; %% có 3 nhiem sac the trong 1 cá the
range=[ 0 0 0 0;...
        2 300 2 300]; %% giá tri Ki kp kd nam trong khoang 0,1
dec=[3 3 3 3]; %% so có 3 chu so thap phân
sig=[5 5 5 5]; %% 5 chu so có nghia, có nghia là 0.00 den 0.99
cross_prob = 0.9; %% muc do cá the con giong ca the me
mutate_prob = 0.1; %% he so dot bien, he so càng lon thì cá the con càng ít giong cá the me
